...
df_locations = pd.read_csv('ENTER GEOJSON FILE HERE')
...
cols = ['ENTER YOUR LIST OF PROPERTIES']  # select which columns to add to properties in geojson
geojson_dict = df_to_geojson(df_locations, properties=cols)

# save the geojson result to a file
with open('ENTER OUTPUT FILE NAME', 'w') as f:
